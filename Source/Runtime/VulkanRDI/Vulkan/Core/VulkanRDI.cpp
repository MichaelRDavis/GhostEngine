...
void CVulkanRDI::InitPipeline()
{
	...
	shaderStages[0].module = LoadShaderModule("C:/Code/GhostEngine/Source/Shaders/glsl/triangle.vert.spv");
	shaderStages[0].pName = "main";

	shaderStages[1].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
	shaderStages[1].stage = VK_SHADER_STAGE_FRAGMENT_BIT;
	shaderStages[1].module = LoadShaderModule("C:/Code/GhostEngine/Source/Shaders/glsl/triangle.frag.spv");
